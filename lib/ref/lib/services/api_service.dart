...
class ApiService {
  ...
  Future<List<Article>> getArticle(String topic) async {
    final endPointUrl =
        "https://newsapi.org/v2/everything?q='${topic}'&from=2022-03-10&sortBy=popularity?country=ja&apiKey=a5e78f194bf44ef4908f5405810114e5";
